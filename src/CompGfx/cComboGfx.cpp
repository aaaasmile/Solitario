...
void cComboGfx::Initialize(SDL_Rect* pRect, SDL_Surface* pScreen,
...
void cComboGfx::SelectIndex(int iIndex) {
...
void cComboGfx::MouseMove(SDL_Event& event, SDL_Surface* pScreen,
...
void cComboGfx::RedrawButton(SDL_Surface* pScreen,
                             SDL_Texture* pScene_background,
                             SDL_Texture* pScreenTexture) {
