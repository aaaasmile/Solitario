...
LanguageMgr::LanguageMgr()
{
    ...
    m_eLangid = LANG_ITA;
    //dialetto
    m_matStringsLang[LANG_DIAL_MN][ID_START] = "C�mincia";
    m_matStringsLang[LANG_DIAL_MN][ID_LANGUAGESEL] = "Lengui fur�sti";
    m_matStringsLang[LANG_DIAL_MN][ID_HISCORE] = "Al m�i di m�i";
    m_matStringsLang[LANG_DIAL_MN][ID_VIDEOSET] = "Gi�sta al display";
    m_matStringsLang[LANG_DIAL_MN][ID_MAINMENU] = "Menu principal";
    m_matStringsLang[LANG_DIAL_MN][ID_EXIT] = "Fnomla che";
    m_matStringsLang[LANG_DIAL_MN][ID_CHOOSELEVEL] = "Cata f�ra al jeuq";
    ...
    m_matStringsLang[LANG_DIAL_MN][ID_BACK] = "Turna indr�";
    m_matStringsLang[LANG_DIAL_MN][ID_SELECTDISPLAYSETTINGS] = "Cata f�ra al display";
    m_matStringsLang[LANG_DIAL_MN][ID_INVIDO] = "Invidu";
    m_matStringsLang[LANG_DIAL_MN][ID_CHOOSELANGUA] = "Cata f�ra la lengua";
    ...
    m_matStringsLang[LANG_DIAL_MN][ID_ANONIM] = "An�nim";
    ...
    m_matStringsLang[LANG_DIAL_MN][ID_SOUNDOPT] = "M�sica";
    m_matStringsLang[LANG_DIAL_MN][ID_ABILITATO] = "Impi�da";
    m_matStringsLang[LANG_DIAL_MN][ID_DISABILITATO] = "Smorsa";

    m_matStringsLang[LANG_DIAL_MN][ID_CHOOSEMAZZO] = "Cata f�ra al mas ad l� carti";
    ...
    m_matStringsLang[LANG_DIAL_MN][ID_SARDEGNA] = "Sardagn�li";
