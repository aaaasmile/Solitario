...
////////////////////////////////////////
//       CanDrop
/*! Dice se si può effettuare il drop
...
bool CCardRegion::CanDrop(CCardStack *stack)
{
	...
	//if empty
	if(InternalStack.Empty() && (AcceptMode&CRD_DOKING) && (vi->Rank() != 10))
		return false;
...
int CCardRegion::GetStackWidth()
{
	...
	return (InternalStack[InternalStack.Size()-1].x + g_CARDWIDTH) - InternalStack[0].x;
}
...
int CCardRegion::GetStackHeight()
{
	...
	return (InternalStack[InternalStack.Size()-1].y + g_CARDHEIGHT) - InternalStack[0].y;
}
