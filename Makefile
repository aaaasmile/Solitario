...
am_solitario_OBJECTS = src/GameGfx/CardRegionGfx.$(OBJEXT) \
	...
	src/Fonts.$(OBJEXT) src/DeckType.$(OBJEXT) \
	src/GameSettings.$(OBJEXT) src/GfxUtil.$(OBJEXT) \
	src/Languages.$(OBJEXT) src/main.$(OBJEXT) \
	src/Fading.$(OBJEXT) src/Credits.$(OBJEXT) \
...
am__depfiles_remade = src/$(DEPDIR)/AppGfx.Po src/$(DEPDIR)/Credits.Po \
	src/$(DEPDIR)/DeckType.Po src/$(DEPDIR)/ErrorInfo.Po \
	src/$(DEPDIR)/Fading.Po src/$(DEPDIR)/Fonts.Po \
	src/$(DEPDIR)/GameSettings.Po src/$(DEPDIR)/GfxUtil.Po \
	src/$(DEPDIR)/HighScoreMgr.Po src/$(DEPDIR)/Languages.Po \
