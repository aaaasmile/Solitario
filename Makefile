...
pkgdatadir = $(datadir)/solitario
pkgincludedir = $(includedir)/solitario
pkglibdir = $(libdir)/solitario
pkglibexecdir = $(libexecdir)/solitario
...
CONFIG_CLEAN_FILES = solitario.spec
CONFIG_CLEAN_VPATH_FILES =
am__installdirs = "$(DESTDIR)$(bindir)"
PROGRAMS = $(bin_PROGRAMS)
am_solitario_OBJECTS = CCardRegion.$(OBJEXT) CCardStack.$(OBJEXT) \
	CGame.$(OBJEXT) cHightScoreMgr.$(OBJEXT) \
...
am__depfiles_remade = ./$(DEPDIR)/CCardRegion.Po \
	./$(DEPDIR)/CCardStack.Po ./$(DEPDIR)/CGame.Po \
	./$(DEPDIR)/CustomMenu.Po ./$(DEPDIR)/EngineApp.Po \
	./$(DEPDIR)/GameSettings.Po ./$(DEPDIR)/Languages.Po \
...
CTAGS = ctags
CSCOPE = cscope
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/solitario.spec.in \
	AUTHORS COPYING ChangeLog INSTALL NEWS README depcomp \
	install-sh missing
...
ACLOCAL = ${SHELL} /mnt/d/scratch/cpp/Solitario/missing aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} /mnt/d/scratch/cpp/Solitario/missing autoconf
AUTOHEADER = ${SHELL} /mnt/d/scratch/cpp/Solitario/missing autoheader
AUTOMAKE = ${SHELL} /mnt/d/scratch/cpp/Solitario/missing automake-1.16
AWK = gawk
CPPFLAGS = 
CXX = g++
...
CXXFLAGS = -g -O2
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"solitario\" -DPACKAGE_TARNAME=\"solitario\" -DPACKAGE_VERSION=\"1.0\" -DPACKAGE_STRING=\"solitario\ 1.0\" -DPACKAGE_BUGREPORT=\"\" -DPACKAGE_URL=\"\" -DPACKAGE=\"solitario\" -DVERSION=\"1.0\"
DEPDIR = .deps
ECHO_C = 
ECHO_N = -n
ECHO_T = 
...
LIBS = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /mnt/d/scratch/cpp/Solitario/missing makeinfo
MKDIR_P = /usr/bin/mkdir -p
OBJEXT = o
PACKAGE = solitario
PACKAGE_BUGREPORT = 
PACKAGE_NAME = solitario
PACKAGE_STRING = solitario 1.0
PACKAGE_TARNAME = solitario
PACKAGE_URL = 
PACKAGE_VERSION = 1.0
PATH_SEPARATOR = :
SET_MAKE = 
...
STRIP = 
VERSION = 1.0
abs_builddir = /mnt/d/scratch/cpp/Solitario
abs_srcdir = /mnt/d/scratch/cpp/Solitario
abs_top_builddir = /mnt/d/scratch/cpp/Solitario
abs_top_srcdir = /mnt/d/scratch/cpp/Solitario
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /mnt/d/scratch/cpp/Solitario/install-sh
...
$(am__aclocal_m4_deps):
solitario.spec: $(top_builddir)/config.status $(srcdir)/solitario.spec.in
...
solitario$(EXEEXT): $(solitario_OBJECTS) $(solitario_DEPENDENCIES) $(EXTRA_solitario_DEPENDENCIES) 
	...
	$(AM_V_CXXLD)$(solitario_LINK) $(solitario_OBJECTS) $(solitario_LDADD) $(LIBS)
...
include ./$(DEPDIR)/CCardRegion.Po # am--include-marker
include ./$(DEPDIR)/CCardStack.Po # am--include-marker
include ./$(DEPDIR)/CGame.Po # am--include-marker
include ./$(DEPDIR)/CustomMenu.Po # am--include-marker
include ./$(DEPDIR)/EngineApp.Po # am--include-marker
include ./$(DEPDIR)/GameSettings.Po # am--include-marker
include ./$(DEPDIR)/Languages.Po # am--include-marker
include ./$(DEPDIR)/cHightScoreMgr.Po # am--include-marker
include ./$(DEPDIR)/cMusicManager.Po # am--include-marker
include ./$(DEPDIR)/credits.Po # am--include-marker
...
distclean: distclean-recursive
	-rm -f $(am__CONFIG_DISTCLEAN_FILES)
		-rm -f ./$(DEPDIR)/CCardRegion.Po
	-rm -f ./$(DEPDIR)/CCardStack.Po
	-rm -f ./$(DEPDIR)/CGame.Po
	-rm -f ./$(DEPDIR)/CustomMenu.Po
	-rm -f ./$(DEPDIR)/EngineApp.Po
	-rm -f ./$(DEPDIR)/GameSettings.Po
	-rm -f ./$(DEPDIR)/Languages.Po
	-rm -f ./$(DEPDIR)/cHightScoreMgr.Po
	-rm -f ./$(DEPDIR)/cMusicManager.Po
	-rm -f ./$(DEPDIR)/credits.Po
